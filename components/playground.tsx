...
const Playground = () => {
  ...
  const saveProgramPreset = (name: string) => {
    ...
    localStorage.setItem("playground-programs", JSON.stringify(programPresets));
  };
  ...
  useEffect(() => {
    const loadWasm = async () => {
      try {
        ...
        const go = new Go();
        const mod = await WebAssembly.instantiate(buffer, go.importObject);
  ...
  return (
    <div className="mx-auto w-4/5 rounded-[2rem]">
      <div className="glass rounded-2xl p-6">
        <div className="hidden h-full flex-col rounded-2xl bg-white md:flex">
            ...
            <div className="container h-full py-6">
              <div className="grid h-full items-stretch gap-6 md:grid-cols-[1fr_200px]">
                <div className="hidden flex-col space-y-4 sm:flex md:order-2">
                  <div className="">
                    <h1 className="mb-1 text-lg">Keywords</h1>
                    <Badges list={keywords} badgeClass="pt-[6px]" />
                  </div>
                  <Separator />
                  <div className="">
                    <h1 className="mb-1 text-lg">Builtins</h1>
                    <Badges list={builtins} />
                  </div>
                  <Separator />
                  <div className="">
                    <h1 className="mb-1 text-lg">Tips</h1>
                  ...
                  <div className="flex flex-col space-y-4">
                    <div className="grid h-full gap-6 lg:grid-cols-2">
                      <div className="flex flex-col space-y-4">
                        ...
                        <div className="flex flex-col space-y-2">
                          <div className="felx-row flex justify-between">
                            ...
                            >
                              <Copy className="mx-1 h-4 w-4" />
                              Copy
                            </Button>
                          </div>
                          <CodeEditor data={data} setData={setData} autofocus />
                        </div>
                        {/* </SplitterPanel>
                                                    <SplitterPanel className="flex align-items-center justify-content-center"> */}
                        <div className="flex flex-col space-y-2">
                      ...
                      <div className="flex flex-col space-y-2">
                        ...
                        <div
                          id="output"
                          className="mt-[21px] h-full min-h-[300px] rounded-md border bg-muted p-2 font-mono lg:min-h-[550px]"
                        >
                          {data.output}
                        </div>
                      </div>
                    ...
                    <div className="flex items-center space-x-2">
                      <Button
                        className="text-lg"
                        onClick={() => {
                          runScriptModeCode(undefined);
                        }}
                      >
                        <Play className="mx-1 h-5 w-5 text-white" />
                        Run
                      </Button>
                      <Button
                        variant="secondary"
