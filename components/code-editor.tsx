...
const CodeEditor: React.FC<CodeEditorProps> = ({ data, setData }) => {
    return (
        <Editor
            ...
            className="w-full rounded-md border-4 border-input bg-transparent text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 min-h-[400px] flex-1 p-4 md:min-h-[700px] lg:min-h-[700px]"
            value={data.code}
