    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button
          ...
          onClick={() => {
            setShareURL(
              `${window.location.href}?play=${compressToEncodedURIComponent(
                JSON.stringify(data),
              )}`,
            );
          }}
      ...
      <PopoverContent align="end" className="w-[420px]">
        <div className="flex flex-col space-y-2 text-center align-middle sm:text-left">
          ...
          <div className="flex flex-col items-center pb-4">
            <h1 className="mb-3 text-base font-medium">Scan QR Code</h1>
            <div id="svg-container" className="rounded ring-8 ring-gray-200">
              <QRCodeSVG
                value={shareURL}
                size={128}
                bgColor={"#ffffff"}
          ...
          <h1 className="self-center text-base font-medium">Share a Link</h1>
