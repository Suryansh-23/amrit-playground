...
export const keywords: {
    ...
    कार्य: (
        <p>
            Also, called <code data-chip="code">karya</code>. Represents a
            function or a block of code.
        </p>
    ),
    माना: (
        <p>
            Also, called <code data-chip="code">mana</code>.Used to assign a
            value to a variable.
        </p>
    ),
    अगर: (
    ...
    वरना: (
        <p>
            Also, called <code data-chip="code">varna</code>. Used in
            conjunction with अगर. Specifies an alternative block of code to
            execute if the condition in अगर is असत्य.
        </p>
    ),
    लाभ: (
        <p>
    ...
    जबतक: (
        <p>
            Also, called <code data-chip="code">jabtak</code>. Specifies a loop
            that continues as long as the specified condition is सत्य. The loop
            will terminate once the condition becomes असत्य.
        </p>
    ),
    सत्य: (
        <p>
            Also, called <code data-chip="code">satya</code>. Represents the
            value for सत्य.
        </p>
    ),
    असत्य: (
        <p>
            Also, called <code data-chip="code">asatya</code>. Represents the
            value for असत्य.
        </p>
    ),
};
...
export const builtins = {
    lambai: (
        <p>
            Similar to <code data-chip="code">len()</code> in Python. Returns
            the length of an array or a string.
        </p>
    ),
    print: (
        <p>
            Similar to <code data-chip="code">print()</code>in Python. Prints
            the specified value to the console.
        </p>
    ),
